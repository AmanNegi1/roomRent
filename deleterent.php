...
<div class="container">
	<div class="row">
        ...
        <?php 
                 // $ConnectingDB;
     //     $getid=$_GET['id'];
                $viewquery="SELECT * FROM roominfo WHERE id='$deleteid' ORDER BY datetime desc";
         ...
         ?>
		    <form action="deleterent.php?deletepost=<?php echo $deleteid; ?>" enctype="multipart/form-data" method="post">
          <fieldset>
        ...
        <!--  <div class="form-group">
          ...
          <div class="form-group">
            ...
            <br>
            <input class="btn btn-success" type="submit" name="Submit" value="Delete Post">
          </fieldset><br>
        </form>
			</div>
