		...
		<div class="well">
			...
			<div id="second">
				...
				<form action="register.php" method="POST">
					...
					<input type="email" name="reg_email" placeholder="abc123@example.com" value="<?php 
					...
					<input type="password" name="reg_password" placeholder="Numbers ||Example- 12344" required>
					<br>
